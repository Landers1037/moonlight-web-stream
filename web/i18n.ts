...
export function getTranslations(language: Language) {
    if (language === "zh-CN") {
        return {
            ...
            settings: {
                ...
                enableHdr: "启用 HDR",
                coordinateOffset: "坐标偏移配置",
                coordinateOffsetStream: "基于串流请求",
                coordinateOffsetVideo: "基于画面尺寸",
                audio: "音频",
    ...
    return {
        ...
        settings: {
            ...
            coordinateOffset: "Coordinate Offset",
            coordinateOffsetStream: "Based on Stream Request",
            coordinateOffsetVideo: "Based on Video Size",
            audio: "Audio",
        ...
        admin: {
            ...
            maximumBitrate: "Maximum Bitrate (Mbps)",
